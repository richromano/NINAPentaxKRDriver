...
namespace Rtg.NINA.NinaPentaxKRDriver.NinaPentaxKRDriverDockables {
    ...
    public class NinaPentaxKRDriverDockable : DockableVM, ICameraConsumer {
        ...
        public NinaPentaxKRDriverDockable(
            ...
            dict.Source = new Uri("Rtg.NINA.NinaPentaxKRDriver;component/NinaPentaxKRDriverDockables/NinaPentaxKRDriverDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Rtg.NINA.NinaPentaxKRDriver_AltitudeSVG"];
