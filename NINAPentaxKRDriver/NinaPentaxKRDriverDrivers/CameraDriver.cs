...
using System.Xml;
using static Rtg.NINA.NinaPentaxKRDriver.NinaPentaxKRDriverDrivers.CameraProvider;
...
namespace Rtg.NINA.NinaPentaxKRDriver.NinaPentaxKRDriverDrivers {
    public class CameraDriver : BaseINPC, ICamera {
        ...
        private static PentaxKRProfile Settings = new PentaxKRProfile();
        ...
        public CameraDriver(IProfileService profileService, ITelescopeMediator telescopeMediator, IExposureDataFactory exposureDataFactory, PentaxKRProfile.DeviceInfo device) {
...
//                    return false;
        ...
        public string Category { get => "PentaxKR"; }
