...
namespace Rtg.NINA.NinaPentaxKRDriver.NinaPentaxKRDriverDrivers {
    ...
    public class CameraProvider : IEquipmentProvider<ICamera> {
        ...
        public string Name => "NINAPentaxKRCamera";
        ...
        public class PentaxKRProfile {
            ...
            public void assignCamera(int index) {
                ...
                m_info.ImageHeightPixels = PentaxKRCameraInfo.ElementAt(index).ImageHeightPixels;
                m_info.LiveViewWidthPixels = PentaxKRCameraInfo.ElementAt(index).LiveViewWidthPixels;
                m_info.LiveViewHeightPixels = PentaxKRCameraInfo.ElementAt(index).LiveViewHeightPixels;
                m_info.PixelWidth = PentaxKRCameraInfo.ElementAt(index).PixelWidth;
                m_info.PixelHeight = PentaxKRCameraInfo.ElementAt(index).PixelHeight;
            }
            ...
            static readonly IList<CameraInfo> PentaxKRCameraInfo = new ReadOnlyCollection<CameraInfo>
                (new[] {
