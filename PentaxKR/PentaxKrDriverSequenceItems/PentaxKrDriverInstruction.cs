...
namespace Rtg.NINA.PentaxKrDriver.PentaxKrDriverTestCategory {
    /// <summary>
    ...
    [ExportMetadata("Category", "Pentax KR Driver")]
    [Export(typeof(ISequenceItem))]
    [JsonObject(MemberSerialization.OptIn)]
    public class PentaxKrDriverInstruction : SequenceItem {
        /// <summary>
        ...
        public PentaxKrDriverInstruction() {
            Text = Settings.Default.DefaultNotificationMessage;
        }
        public PentaxKrDriverInstruction(PentaxKrDriverInstruction copyMe) : this() {
            CopyMetaData(copyMe);
        }
        ...
        public override object Clone() {
            return new PentaxKrDriverInstruction(this);
        }
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(PentaxKrDriverInstruction)}, Text: {Text}";
        }
    }
}