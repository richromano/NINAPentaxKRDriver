...
namespace Rtg.NINA.PentaxKrDriver.PentaxKrDriverTestCategory {
    ...
    public class PentaxKrDriverTrigger : SequenceTrigger {
        /// <summary>
        ...
        public PentaxKrDriverTrigger() {
        }

        public override object Clone() {
            return new PentaxKrDriverTrigger() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(PentaxKrDriverTrigger)}";
        }
    }
}