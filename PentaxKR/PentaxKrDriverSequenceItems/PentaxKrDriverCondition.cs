...
namespace Rtg.NINA.PentaxKrDriver.PentaxKrDriverTestCategory {
    ...
    public class PentaxKrDriverCondition : SequenceCondition {
        /// <summary>
        ...
        public PentaxKrDriverCondition() {
            IsTruthy = true;
        }
        ...
        public override object Clone() {
            return new PentaxKrDriverCondition() {
                Icon = Icon,
                Name = Name,
                Category = Category,
        ...
        public override string ToString() {
            return $"Category: {Category}, Item: {nameof(PentaxKrDriverCondition)}, IsTruthy: {IsTruthy}";
        }
    }
}