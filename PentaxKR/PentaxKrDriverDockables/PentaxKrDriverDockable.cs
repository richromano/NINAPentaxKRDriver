...
namespace Rtg.NINA.PentaxKrDriver.PentaxKrDriverDockables {
    /// <summary>
    ...
    public class PentaxKrDriverDockable : DockableVM, ITelescopeConsumer {
        private INighttimeCalculator nighttimeCalculator;
        private ITelescopeMediator telescopeMediator;

        [ImportingConstructor]
        public PentaxKrDriverDockable(
            ...
            dict.Source = new Uri("Rtg.NINA.PentaxKrDriver;component/PentaxKrDriverDockables/PentaxKrDriverDockableTemplates.xaml", UriKind.RelativeOrAbsolute);
            ImageGeometry = (System.Windows.Media.GeometryGroup)dict["Rtg.NINA.PentaxKrDriver_AltitudeSVG"];
