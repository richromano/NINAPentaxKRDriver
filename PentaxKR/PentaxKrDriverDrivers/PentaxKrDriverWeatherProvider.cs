...
namespace Rtg.NINA.PentaxKrDriver.PentaxKrDriverDrivers {
    /// <summary>
    ...
    public class PentaxKrDriverWeatherProvider : IEquipmentProvider<IWeatherData> {
        private IProfileService profileService;

        [ImportingConstructor]
        public PentaxKrDriverWeatherProvider(IProfileService profileService) {
            this.profileService = profileService;
        }

        public string Name => "PentaxKrDriver";

        public IList<IWeatherData> GetEquipment() {
            var devices = new List<IWeatherData>();
            devices.Add(new PentaxKrDriverWeatherDriver("MyUniqueId", "MyDeviceId"));
