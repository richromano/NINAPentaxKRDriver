...
namespace Rtg.NINA.PentaxKrDriver.PentaxKrDriverDrivers {
    ...
    /// </summary>
    public class PentaxKrDriverWeatherDriver : BaseINPC, IWeatherData {
        public PentaxKrDriverWeatherDriver(string uniqueId, string deviceId) {
            Id = uniqueId;
            serialNumber = deviceId;
            Name = $"PentaxKrDriver Weather Data ({deviceId})";
        ...
        public string Category => "PentaxKrDriver Weather Driver";
